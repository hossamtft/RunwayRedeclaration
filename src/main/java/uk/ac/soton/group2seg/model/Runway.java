...
/**
 * Represents a physical runway, which consists of two logical runways.
 * This class is annotated for JAXB to allow marshalling and unmarshalling to and from XML.
 *
...
public class Runway {
  ...
  /**
   * Default constructor for JAXB and general use.
  ...
  /**
   * Constructs a runway made up of two logical runways.
   * The name of the runway is derived from the names of the provided logical runways.
   *
   ...
   * This method is used by JAXB during unmarshalling.
   *
  ...
  /**
   * Sets the list of logical runways.
   * This method is used by JAXB during unmarshalling.
   *
  ...
  /**
   * Parses the numeric heading from a runway name.
   * Runway names are expected to contain numeric headings (e.g., "09L", "27R").
   *
